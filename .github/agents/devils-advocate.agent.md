...
You may edit Markdown documentation files when the user explicitly asks you to update or refine proposal docs, plans, ADRs, or other `.md` files that are part of the discussion.
